...
export const SYNTAX_FEATURES: SyntaxFeature[] = [
  ...
  },
  {
    id: 'task-list',
    name: 'Task list',
    description: '保留未完成與已完成狀態，Preview 與 DOCX 皆使用核取方塊而非項目符號。',
    syntax: '- [ ] task / - [x] done',
    example: '- [ ] 待確認項目\n- [x] 已完成項目',
    status: 'supported',
    coverage: {
...
export const SYNTAX_COMMANDS: SyntaxCommandSpec[] = [
  ...
  { id: 'bullet-list', featureId: 'list', label: 'Bullet list', description: '插入項目清單', insertText: '- ', group: 'List', quickAction: true },
  { id: 'numbered-list', featureId: 'list', label: 'Numbered list', description: '插入編號清單', insertText: '1. ', group: 'List', quickAction: true },
  { id: 'todo-list', featureId: 'task-list', label: 'Task list', description: '插入待辦清單', insertText: '- [ ] ', group: 'List', quickAction: true },
  { id: 'quote', featureId: 'quote', label: 'Quote', description: '插入引用段落', insertText: '> ', group: 'Basic', quickAction: true },
  ...
  { id: 'chat-center', featureId: 'chat', label: 'System dialogue', description: '插入置中對話泡泡', insertText: 'System :": 這裡輸入系統訊息', group: 'Chat', quickAction: true },
  { id: 'image', featureId: 'image', label: 'Image', description: '插入圖片語法', insertText: '![圖片說明](url)', group: 'Media', quickAction: true },
  { id: 'qr', featureId: 'qr', label: 'QR code', description: '插入獨立 QR 連結', insertText: '[QR:連結標籤](https://example.com)', group: 'Media', quickAction: true },
